...
statement
    ...
    | CREATE MBT INDEX indexIdentifier=identifier ON
        tableIdentifier '(' column=identifier ')'                      #createMBTIndex
...
valueExpression
    ...
    | leftTable=primaryExpression IN MBTRANGE '(' center=mbtPointExpression
...
odbPointExpression
    : ODBPOINT '(' mcoords=metricCoords ')'
    ;


obtCoords
    :  scoords+=mixedItems (' ' scoords+=mixedItems)*
    ;

...
public class SqlBaseLexer extends Lexer {
	...
	public static final int
		...
		BRACKETED_COMMENT=275, WS=276, UNRECOGNIZED=277;
	...
	private static String[] makeRuleNames() {
		return new String[] {
			...
			"T__9", "SELECT", "FROM", "ADD", "AS", "ALL", "DISTINCT", "WHERE", "GROUP", 
			...
			"CURRENT_TIMESTAMP", "MCHORD", "AMDS", "MBT", "ODB", "EUCLID", "L1", 
			"COSINE", "EDIT", "METRICPOINT", "AMDSPOINT", "MBTPOINT", "ODBPOINT", 
			"METRICM", "QUERYM", "METRICRANGE", "AMDSRANGE", "MBTRANGE", "ODBRANGE", 
			"ODBKNN", "DTW", "FRECHET", "EDR", "LCSS", "TRIE", "KNN", "TRAJECTORY", 
			"POINT", "MBRRANGE", "CIRCLERANGE", "STRING", "BIGINT_LITERAL", "SMALLINT_LITERAL", 
